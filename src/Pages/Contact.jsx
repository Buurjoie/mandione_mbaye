...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://formsubmit.co/seydinamandionem9@gmail.com', {
        method: 'POST',
        body: formData
      });
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                Vous avez quelque chose à discuter? Envoyez-moi un message et parlons.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                {isSubmitting ? 'Envoie...' : 'Envoyer Message'}
              </button>
            </form>
