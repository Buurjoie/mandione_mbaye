...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
    <div className="relative group">
      ...
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-gray-200/10 dark:border-white/10">
  ...
  <div className="space-y-2 text-center" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      <span className="relative inline-block">
        ...
        <span className="relative bg-gradient-to-r from-gray-800 dark:from-white via-blue-100 to-purple-200 dark:to-purple-300 bg-clip-text text-transparent">
          Developeur
        </span>
      </span>
      {/* <br /> */}
...
const TechStack = memo(({ tech }) => (
  <div className="px-4 py-2 hidden sm:block rounded-full bg-gray-100/60 dark:bg-white/5 backdrop-blur-sm border border-gray-200/20 dark:border-white/10 text-sm text-gray-800 dark:text-gray-300 hover:bg-gray-200/50 dark:hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[160px]">
      ...
      <div className="relative h-11 bg-white dark:bg-[#030014] backdrop-blur-xl rounded-lg border border-gray-200/10 dark:border-white/10 leading-none overflow-hidden">
        <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-gradient-to-r from-[#4f52c9]/20 to-[#8644c5]/20"></div>
        <span className="absolute inset-0 flex items-center justify-center gap-2 text-sm group-hover:gap-3 transition-all duration-300">
          <span className="bg-gradient-to-r from-gray-800 dark:from-gray-200 to-gray-900 dark:to-white bg-clip-text text-transparent font-medium z-10">
            {text}
          </span>
          <Icon className={`w-4 h-4 text-gray-900 dark:text-gray-200 ${text === 'Contact' ? 'group-hover:translate-x-1' : 'group-hover:rotate-45'} transform transition-all duration-300 z-10`} />
        </span>
      </div>
    </button>
  </a>
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-3">
      ...
      <div className="relative rounded-xl bg-white/60 dark:bg-black/50 backdrop-blur-xl p-2 flex items-center justify-center border border-gray-200/10 dark:border-white/10 group-hover:border-gray-300 dark:group-hover:border-white/20 transition-all duration-300">
...
const WORDS = ["Développement de sites web", "Développement d'Application Mobile", "Maintenance et mise à jour", "Optimisation des performances et SEO", "Développement de back-end robuste"];
const TECH_STACK = ["React", "Angular", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Mandionelaye" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/seydina-mandione-mbaye-4b584a269/" },
  { icon: YouTube, link: "https://www.youtube.com/@Buur_Digital" }
];
