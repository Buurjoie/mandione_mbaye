    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                <label className="block text-sm font-medium text-white">
                 Photo de profil <span className="text-gray-400">(optional)</span>
                </label>
                    ...
                    {imagePreview ? (
                        ...
                        <div className="w-full" >
                            ...
                            >
                                ...
                                <span>Choisissez la photo du profil</span>
                            </button>
                            <p className="text-center text-gray-400 text-sm mt-2">
                               Taille du fichier maximum: 5MB
                            </p>
                        </div>
                    )}
                </div>
...
const Komentar = () => {
    ...
    return (
        <div className="w-full bg-white/5 from-white/10 to-white/5 rounded-2xl overflow-hidden backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="space-y-4 h-[300px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
                    <div className="text-center py-8" data-aos="fade-in">
                        ...
                        <p className="text-gray-400">Aucun commentaire encore. Commencez la conversation!</p>
                    </div>
                ) : (
