...
const socialLinks = [
  {
    ...
    subText: "Seydina Mandione Mbaye",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/seydina-mandione-mbaye-4b584a269/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Buur_Digital",
    icon: Instagram,
    url: "https://www.instagram.com/Buur_Digital/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Buur_Digital",
    icon: Youtube,
    url: "https://www.youtube.com/@Buur_Digital",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Mandionelaye",
    icon: Github,
    url: "https://github.com/Mandionelaye",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@Buur_Digital",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-white/5 from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
